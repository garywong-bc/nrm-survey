...
NOTE: To update our LimeSurvey image, we would update or override the Dockerfile ARG, and run the [Build](./ci/openshift/limesurvey-bcgov.bc.yaml). For example, this v5.3.21 was built with:
